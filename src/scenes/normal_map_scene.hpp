...
private:
  ...
  Texture texture_diffuse_ = Texture::Load("diffuse", "resources/textures/brickwall.jpg");
  Texture texture_normal_ = Texture::Load("normal", "resources/textures/brickwall_normal.jpg");
