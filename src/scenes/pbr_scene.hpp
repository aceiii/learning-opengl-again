...
public:
  ...
  void Init(IAppContext* ctx) override {
    ...
    // ssao_shader_ = Shader::FromFiles("resources/shaders/pbr_scene/ssao.vs", "resources/shaders/pbr_scene/ssao.fs");
    // blur_shader_ = Shader::FromFiles("resources/shaders/pbr_scene/blur.vs", "resources/shaders/pbr_scene/blur.fs");
    // lighting_shader_ = Shader::FromFiles("resources/shaders/pbr_scene/main.vs", "resources/shaders/pbr_scene/main.fs");
    // light_shader_ = Shader::FromFiles("resources/shaders/pbr_scene/light.vs", "resources/shaders/pbr_scene/light.fs");
  ...
  void Render() override {
    ...
    */
    ...
    shader_.Use();
    shader_.SetInt("width", frame_width);
    shader_.SetInt("height", frame_height);
    shader_.SetMat4("view", camera_.GetViewMatrix());
    shader_.SetMat4("projection", projection_);
    shader_.SetVec3("viewPos", camera_.position);
    RenderQuad();
